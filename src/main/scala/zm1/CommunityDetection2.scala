...
import org.apache.spark.graphx.lib.{LabelPropagation, TriangleCount}
...
object CommunityDetection2 {
  def main(args: Array[String]): Unit = {
    ...
    val labelGraph = TriangleCount.run(graph)
    ...
    val array: Array[Edge[Link]] = graph.edges.collect()
